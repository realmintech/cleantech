...
const Sidebar = ({ toggleTheme, isDarkMode }) => {
  return (
    <div className="h-screen w-72 text-white p-6 flex flex-col border-r border-white/10 bg-gradient-to-b from-teal-900 to-teal-900 shadow-2xl backdrop-blur-xl fixed top-0 left-0 dark:bg-teal-950 dark:from-teal-800 dark:to-teal-950">
